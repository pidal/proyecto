<div class="col-xs-12">
    <div class="col-sm-12 col-sm-offset-4">
        ...
        <div style="margin-top: 20px">
            <div class="form-group">
                ...
                <input id="name" type="text"
                       ...
                       name="name" value="{{ old('name') }}" requisi autofocus />
                    @if ($errors->has('name'))
        ...
        @if (empty($student) || count($student) == 0 || count($student) != old('number_files_delivered'))
            <div>
                <div class="form-group">
                    ...
                    <input onclick="BuildFormFields(parseInt(this.value, 10));"
                           ...
                           required="required"
                           value="{{ old('number_files_delivered') }}" requisi autofocus />
        ...
        @endif
            ...
            <div class="form-group" style="margin-top: 20px">
                ...
                <input id="attempts" type="number"
                       ...
                       min='1' placeholder=">=1" name="attempts" value="{{ old('attempts') }}"
                       required="required"
                       requisi>
