        ...
        <div class="row justify-content-center">
            <div class="col-sm-4 col-sm-offset-4" style="margin-top: 140px; margin-left: 150px; margin-right: 150px;">
                ...
                <div style="overflow: hidden; border: 2px solid #ccc;   text-align: left; background-color: #fafafa;">
                    ...
                    <form action="{{ route('showResultsStudent',array('subject_id'=>$subject->id,'assignment_id'=>$assignment->id,)) }}" method="post">
                        @csrf
                        <input type="hidden" name="assignment_id" value="<?php echo $assignment->id?>">
                        <input type="hidden" name="group_assignment_id" value="<?php echo $assignment->group_assignment_id?>">
