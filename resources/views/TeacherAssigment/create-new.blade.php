	...
	<div class="row justify-content-center">
		<div class="col-sm-8 col-sm-offset-2" style="margin-top: 100px">
			...
			<form class="form-horizontal" method="POST" action="{{ route('teacherassignmentcreate') }}" role="form" enctype="multipart/form-data">
                @csrf
                <h4><span class="badge badge-pill badge-primary">1</span> Datos basicos</h4>
                <div class="row">
                	<div class="col-md-6">
				...
				<div class="row">
					<div class="col-md-12">
						<div id="grupos_number" class="form-group" style="margin-top: 20px;{{ old('members_number') == ""?'display: none;':''  }}">
