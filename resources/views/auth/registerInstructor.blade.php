    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-sm-4 col-sm-offset-4" style="margin-top: 100px">
                ...
                <form class="form-horizontal" action="{{ route('registerInstructor') }}" method="post"  enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="no box" style="margin-top: 20px">
                        ...
                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" requisi autofocus>
                        @if ($errors->has('name'))
                    ...
                    <div class="no box">
                        <div class="form-group">
                            ...
                            <input id="surname" type="text" class="form-control{{ $errors->has('surname') ? ' is-invalid' : '' }}" name="surname" value="{{ old('surname') }}" requisi autofocus>
                    ...
                    <div class="no box">
                        ...
                        <label for="email">{{ __('E-Mail') }}</label>
                            <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" requisi>
                            @if ($errors->has('email'))
                                <span class="invalid-feedback" role="alert">
                    ...
                    <div class="si box" style="margin-top: 20px">
                        ...
                        <input id="file" type="file" class="form-control{{ $errors->has('file') ? ' is-invalid' : '' }}" name="file" value="{{ old('file') }}" requisi>
                        @if ($errors->has('file'))
                            <span class="invalid-feedback" role="alert">
