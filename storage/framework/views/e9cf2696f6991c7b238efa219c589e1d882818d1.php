...
<?php echo $__env->yieldContent('header'); ?>
    <div class="bg-img">
        <div class="menu">
            <div class="topnav">
                <a href="<?php echo e(url('/createAssignment')); ?>">Crear práctica</a>
                <a href="<?php echo e(url('/showSubjects')); ?>">Mostrar prácticas</a>
                <a href="<?php echo e(url('/usuariosInstructor')); ?>">Alumnos</a>
                <a href="<?php echo e(url('/subjects')); ?>">Asignaturas</a>
