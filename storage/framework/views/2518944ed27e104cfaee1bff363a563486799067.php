...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        selectSubject.change(function(event){
            ...
            $.ajax({
                type:'GET',
                url: "<?php echo e(route('numberofstudentsbysubject')); ?>",
        ...
        //inputMemeberNumber.click(BuildFormFields2);
            ...
            for ($j = 1; $j < groups + 1; $j++) {
                ...
                for ($i = 1; $i < $amount + 1; $i++) {
                    ...
                    if ($k <= alumno) {
                        ...
                        $option.value = null;
                        $option.text = "<?php echo e(__("Seleccione un Estudiante")); ?>";
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-sm-4 col-sm-offset-4" style="margin-top: 140px">
                ...
                <form id="form_" class="form-horizontal was-validated" action="<?php echo e(url('createAssignment')); ?>" method="post"
                      enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="row setup-content justify-content-center" id="step-1">
                        <?php echo $__env->make('layouts.createAssignment-Step1', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="row setup-content justify-content-center" id="step-2">
                        <?php echo $__env->make('layouts.createAssignment-Step2', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                    <div class="row setup-content justify-content-center" id="step-3">
                        <?php echo $__env->make('layouts.createAssignment-Step3', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                    </div>
                </form>
            </div>
        </div>
